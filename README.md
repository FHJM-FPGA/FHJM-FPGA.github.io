      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="pages/about.html" class="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-lg transition-all transform hover:scale-105 font-medium shadow-lg hover:shadow-primary/20">
              了解更多
            </a>
            <a href="posts/" class="bg-white hover:bg-gray-50 text-primary border border-primary px-8 py-3 rounded-lg transition-all transform hover:scale-105 font-medium shadow-md">
              浏览博客
            </a>
          </div>
        </div>
